...
import com.apple.commons.model.UserVisitAction
import com.apple.commons.utils.{DateUtils, NumberUtils, ParamUtils}
...
/**
  * @Program: commerce
  * @ClassName: PageOneStepConvertRate
  * @Description: TODO
  * @Author Mr.Apple
...
object PageOneStepConvertRate {
  ...
  def persistConvertRate(spark: SparkSession, taskid: String, convertRateMap: mutable.HashMap[String, Double]): Unit = {
  ...
  /**
    ...
    * @return
    */
  def getStartPagePv(taskParam: JSONObject, sessionid2actionsRDD: RDD[(String, Iterable[UserVisitAction])]) = {
