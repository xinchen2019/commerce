package com.apple.commons.pool
...
/**
  * @Program: commerce
  * @ClassName: PooledMySqlClientFactory
  * @Description: 管理Mysql对象池
  * @Author Mr.Apple
...
/**
  ...
  */
case class MySqlProxy(jdbcUrl: String,
                      jdbcUser: String,
                      jdbcPassword: String,
                      client: Option[Connection] = None) {
...
/**
  ...
  * @param client
  */
class PooledMySqlClientFactory(jdbcUrl: String,
                               jdbcUser: String,
                               jdbcPassword: String,
                               client: Option[Connection] = None)
