...
class SessionAggrStatAccumulator extends AccumulatorV2[String, mutable.HashMap[String, Int]] {
  ...
  override def isZero: Boolean = aggrStatMap.isEmpty
  ...
  override def reset(): Unit = aggrStatMap.clear()
  ...
  override def value: mutable.HashMap[String, Int] = this.aggrStatMap
}
